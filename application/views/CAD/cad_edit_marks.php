...
<div id="wrapper">
    ...
    <div id="page-wrapper" class="gray-bg">
        ...
        <div class="row wrapper border-bottom white-bg page-heading">
            <div class="col-lg-10">
                <h2><span class="fa fa-users"></span> Edit Marks</h2>
                <ol class="breadcrumb">
                    <li>
                        <a>Tests</a>
                    </li>
                ...
                <div class="col-sm-12 col-md-5 col-lg-5">
                    <div class="ibox float-e-margins">
                        ...
                        <div class="ibox-content">
                            <?php
                            if ($stc != null) {
                                echo "<label class='control-label'>Student:  $student->first_name $student->last_name</label>";
                            }
                            ?>
                            <form action="<?= base_url('index.php/tests/select_stc') ?>" id="add_class_form"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <select name="stc" id="stc"
                                                class="form-control">
                                            <?php foreach ($stc_list as $the_stc): ?>
                                                <option
                                                    value="<?= $the_stc->id ?>"><?= "$the_stc->year - $the_stc->month (Term $the_stc->term)" ?></option>
                                            <?php endforeach; ?>
                                        </select>
                                    </div>
                                </div>
                    ...
                    <div class="col-sm-12 col-md-7 col-lg-7">
                        <div class="ibox float-e-margins">
                            ...
                            <div class="ibox-content">
                                ...
                                <form action="<?= base_url("/index.php/tests/new_mark/$stc/edit") ?>" method="POST"
                                      class="form-inline">
                                    <div class="form-group">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="btn-group-sm">
                                                    <a href="<?= base_url("/index.php/tests/delete_mark/$stc/$mark->id/edit") ?>"
