...
<div class="middle-box text-center loginscreen  animated fadeInDown">
    <div>
        <div>
            ...
            <h1 class="logo-name"><img class="img-responsive m-t-xl"
                                       src="<?php echo base_url('assets'); ?>/img/CADLogo.png" alt="CAD Logo"/></h1>

        </div>
        <h3 class="m-t-md">Colour A Dream Web Portal</h3>
