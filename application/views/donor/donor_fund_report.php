...
<div id="wrapper">
    ...
    <div id="page-wrapper" class="gray-bg">
        ...
        <div class="row wrapper border-bottom white-bg page-heading">
            <div class="col-lg-8">
                <h2><span class="fa fa-newspaper-o"></span> Fund Summary Report</h2>
                <ol class="breadcrumb">
                    <li>
                        Reports
                    </li>
                    <li class="active">
                        <strong>Fund Summary Report</strong>
                    </li>
                </ol>
            </div>
            <div class="col-lg-4">
                <div class="title-action">
                    <form target="_blank" class="form-inline m-sm" action="<?= base_url('/index.php/reports/fund_report/summary_print') ?>"
                          method="post">
        ...
        <div class="wrapper white-bg row">
            <div class="col-sm-12">
                <form class="form-inline m-sm" action="<?= base_url('/index.php/reports/fund_report/summary') ?>"
                      method="post">
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="wrapper wrapper-content animated bounceIn">
                    <?php $this->load->view('donor/donor_fund_report_data'); ?>
                </div>
            </div>
        </div>
        <div class="footer">
