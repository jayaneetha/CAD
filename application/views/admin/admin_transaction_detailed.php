...
<div id="wrapper">
    ...
    <div id="page-wrapper" class="gray-bg">
        ...
        <div class="row wrapper border-bottom white-bg page-heading">
            <div class="col-lg-8">
                <h2><span class="fa fa-newspaper-o"></span> Transaction Detailed Report</h2>
                <ol class="breadcrumb">
                    <li>
                        Reports
                    </li>
                    <li class="active">
                        <strong>Transaction Detailed Report</strong>
                    </li>
                </ol>
            </div>
            <div class="col-lg-4">
            ...
            <div class="col-sm-12">
                <form class="form-inline m-sm" action="#" method="get">
                    ...
                    <div class="form-group m-l-xl">
                        <label for="approved">Show Accepted only: </label>
                        <input type="checkbox" name="show_accepted" id="show_accepted" value="show"/>
                    </div>
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="wrapper wrapper-content animated bounceIn">
                    <?php $this->load->view('admin/admin_transaction_detailed_data'); ?>
                </div>
            </div>
        </div>
        <div class="footer">
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        new Switchery(document.querySelector('#show_accepted'), {color: '#1AB394'});
